...
A similar publisher was officially added to the MPPI controller in the Main branch, but since this was after Nav2 underwent an overhaul, this version is not compatible with ROS2 Jazzy.
